...
import { LayoutDashboard, ScrollText, Trophy, LogOut, Map, User, Cloud, Compass } from "lucide-react";
...
const tabs = [
  ...
  { to: "/eco-travel", label: "Eco travel", icon: Compass },
  { to: "/footprint", label: "CO₂", icon: Cloud },
